...
LOAD DATA LOCAL INFILE '/data/emonet/ncats/kegg/concepts.txt' 
...
LOAD DATA LOCAL INFILE '/data/emonet/ncats/kegg/concept_counts.txt' 
...
LOAD DATA LOCAL INFILE '/data/emonet/ncats/kegg/concept_pair_counts.txt' 
