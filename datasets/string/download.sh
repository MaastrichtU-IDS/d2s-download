...
wget -a download.log http://version10.string-db.org/download/protein.actions.v10/9606.protein.actions.v10.txt.gz
wget -a download.log http://string91.embl.de/newstring_download/protein.actions.v9.1/9606.protein.actions.v9.1.txt.gz
