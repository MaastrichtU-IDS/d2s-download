...
wget -a download.log --save-cookies cookies.txt \
     ...
     --post-data 'public_user[email]=$drugbank_login&public_user[password]=$drugbank__password&public_user[remember_me]=1&authenticity_token=duGIJGcyaSmNlV9gl4l0kJPIaXZy8osM405HmEjZhQTIMUwxrwXvnaZ61zQKq0kWo9HhuvqGLo9VODFYrMX5Kg&commit=Signin' \
