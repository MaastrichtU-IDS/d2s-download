...
wget -a download.log --save-cookies cookies.txt \
     ...
     --post-data 'public_user[email]=$drugbank_login&public_user[password]=$drugbank_password&public_user[remember_me]=1&commit=Signin' \
...
wget -a download.log --save-cookies cookies.txt \
     --keep-session-cookies \
     --post-data 'public_user[email]=vincent.emonet@maastrichtuniversity.nl&public_user[password]=maasitest12&public_user[remember_me]=1&commit=Signin' \
     https://www.drugbank.ca/public_users/sign_in
...
# GENERATE SIGNATURE? http://blog.0xpebbles.org/shell-script-for-S3-upload-via-curl-using-AWS-version-4-signatures


wget -a download.log -O drugbank_all_full_database.xml.zip --load-cookies cookies.txt "https://drugbank.s3.us-west-2.amazonaws.com/public_downloads/downloads/000/002/022/original/drugbank_all_full_database.xml.zip?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=AKIAJTZC3DSCEEG75A6Q%2F20180719%2Fus-west-2%2Fs3%2Faws4_request&X-Amz-Date=20180719T003719Z&X-Amz-Expires=10&X-Amz-SignedHeaders=host"

wget -O drugbank_all_full_database.xml.zip --load-cookies cookies.txt "https://drugbank.s3.us-west-2.amazonaws.com/public_downloads/downloads/000/002/022/original/drugbank_all_full_database.xml.zip?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=1060e3ab56c3e0715f96ead254ca3784bf276d92%2F20180719%2Fus-west-2%2Fs3%2Faws4_request&X-Amz-Date=20180719T003719Z&X-Amz-Expires=10&X-Amz-SignedHeaders=host&X-Amz-Signature=de6acc03ffbf47c74775d4832dba044ae1532447964"
